...
//
// Master bitmask: bit 2=Bloom, bit 3=Tonemapping
// Individual cvars: 0=use cg_hq bitmask, 1=force on, -1=force off
//============================================================================

export const cg_hq = new cvar_t( 'cg_hq', '12', true ); // 12 = Bloom + Tonemapping
...
// R_ApplyHQEffects
//
// Applies HQ visual fidelity post-processing effects (Bloom, Tonemapping).
//============================================================================
